...
// insertando codigo Jquery . Desafio que vence el 01-11

function initHover() {
    $('.img-fluid').css('transition', ' all 700ms');
    $('.img-fluid').css('top', '-7px');
    $('.img-fluid').css('opacity', '0.5');
}

function finishHover() {
    $('.img-fluid').css('transition', 'all 700ms');
    $('.img-fluid').css('top', '0px');
    $('.img-fluid').css('opacity', '1.0');

}

$(document).ready(
    $('.img-fluid').hover(initHover, finishHover)
)
